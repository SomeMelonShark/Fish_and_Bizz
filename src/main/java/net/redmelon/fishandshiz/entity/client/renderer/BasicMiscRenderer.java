...
public class BasicMiscRenderer <E extends LivingEntity & GeoAnimatable> extends GeoEntityRenderer<E> {

    public BasicMiscRenderer(EntityRendererFactory.Context ctx, GeoModel<E> modelProvider) {
