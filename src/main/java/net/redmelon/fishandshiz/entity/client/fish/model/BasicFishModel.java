...
public class BasicFishModel<A extends LivingEntity & GeoAnimatable> extends GeoModel<A> {
    ...
    public BasicFishModel(Identifier model, Identifier texture, Identifier animation, @Nullable String head) {
        this.model = model;
    ...
    public BasicFishModel(String name, @Nullable String head) {
        this(
