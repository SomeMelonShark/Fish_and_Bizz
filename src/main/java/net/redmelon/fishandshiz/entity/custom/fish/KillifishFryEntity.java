...
public class KillifishFryEntity extends KillifishEntity implements GeoEntity, EntitySize {

    public KillifishFryEntity(EntityType<? extends KillifishEntity> entityType, World world) {
    ...
    protected void growUp() {
        ...
        if (world instanceof ServerWorld) {
            ...
            KillifishEntity nextEntity = ModEntities.KILLIFISH.create(this.getWorld());
            if (nextEntity != null) {
