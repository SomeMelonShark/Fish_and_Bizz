...
public class CrayfishEggEntity extends CrayfishEntity implements GeoEntity  {
    @VisibleForTesting
    public static int MAX_EGG_AGE = Math.abs(-18000);
    private int eggAge;

    private final AnimatableInstanceCache factory = GeckoLibUtil.createInstanceCache(this);
    public CrayfishEggEntity(EntityType<? extends CrayfishEntity> entityType, World world) {
    ...
    public ItemStack getBucketItem() {
        return new ItemStack(ModItems.CRAYFISH_EGG_BUCKET);
    }
