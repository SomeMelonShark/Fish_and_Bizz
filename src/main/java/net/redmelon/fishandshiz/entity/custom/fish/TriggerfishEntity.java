...
public class TriggerfishEntity extends SchoolingBreedEntity implements GeoEntity, VariableFishEntity<TriggerfishPattern, TriggerfishDetail> {
    ...
    protected void initGoals() {
        ...
        this.targetSelector.add(1, new ActiveTargetGoal<>((MobEntity)this, PlayerEntity.class, true));
