...
public class AuratusEntity extends SchoolingBreedEntity implements GeoEntity {
    public static final Ingredient FISH_FOOD = Ingredient.ofItems(ModItems.FISH_FOOD);
    private final AnimatableInstanceCache factory = GeckoLibUtil.createInstanceCache(this);
    public AuratusEntity(EntityType<? extends SchoolingBreedEntity> entityType, World world) {
    ...
    public @Nullable PassiveWaterEntity createChild(ServerWorld var1, PassiveWaterEntity var2) {
        return ModEntities.AURATUS_EGG.create(getWorld());
    }
