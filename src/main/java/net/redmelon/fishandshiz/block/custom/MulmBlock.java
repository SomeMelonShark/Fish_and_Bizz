...
public class MulmBlock extends SpreadableBlock implements Fertilizable {
    public MulmBlock(Settings settings) {
        super(settings);
    }
    ...
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
        ...
        BlockState blockState = ModBlocks.MULM.getDefaultState();
