...
public abstract class EggboundEntity extends AnimalWaterEntity {
    @VisibleForTesting
    protected static int MAX_EGG_AGE = Math.abs(-18000);
    private int gestStage;
    protected static final TrackedData<Boolean> HAS_EGG = DataTracker.registerData(EggboundEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    protected EggboundEntity(EntityType<? extends AnimalWaterEntity> entityType, World world) {
