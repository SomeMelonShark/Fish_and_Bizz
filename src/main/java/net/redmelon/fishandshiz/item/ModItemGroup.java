...
public class ModItemGroup {
    /**Test Group**/
    public static final ItemGroup FISH_AND_BIZZ = Registry.register(Registries.ITEM_GROUP, new Identifier(FishAndShiz.MOD_ID, "fishandshiz"),
            FabricItemGroup.builder()
                    .displayName(Text.translatable("itemgroup.fishandshiz"))
                    .icon(() -> new ItemStack(ModItems.MUD_CRAB)).entries((displayContext, entries) -> {
